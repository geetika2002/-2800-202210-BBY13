    ...
    if (req.session) {
        ...
        connection.query(
            ...
            function (error, userresults, fields) {
                ...
                const allUsers =
                    profileDOM.window.document.createElement("table");
            ...
            function (error, results, fields) {
                ...
                for (let i = 0; i < results.length; i++) {
                    if (req.session.user_edit == results[i].username) {
                        ...
                        const email =
                            profDOM.window.document.getElementById("mail");
                        let mail =
                        ...
                        const pwd =
                            profDOM.window.document.getElementById("pwd");
                        let password =
...
app.get("/checkout", function (req, res) {
  ...
  database: "rz2y3uh9vljkf5dz",
        ...
        const orderconfirm =
            profileDOM.window.document.getElementById("welcome");
            ...
            function (error, productRecord, fields) {
                ...
                if (productRecord) {
                    for (let i = 0; i < productRecord.length; i++) {
                        ...
                        let prodName =
                            "<h3 id=prod_name>" +
                            productRecord[i].name +
                            "</h3>";
                        prodInfo.innerHTML += prodName;

                        let price =
                            "<h4 id=price>" + productRecord[i].price + "<h4/>";
